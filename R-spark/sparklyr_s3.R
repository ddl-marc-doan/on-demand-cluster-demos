...
# Make sure to set AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY as environment variables
system.time(perf_data <- spark_read_csv(sc, name = "perf_data", path='s3a://marcdo-cldemo-blobs/datademo/2021Q1.csv', sep="|", memory = FALSE, header = FALSE))
...
sql_query = 'SELECT DISTINCT MASTER_SERVICER FROM loan_data'
